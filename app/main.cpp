...
int main() {
    ...
    */
    ...
    RandomDatasetGenerator::ColumnDataType binom{
            RandomDatasetGenerator::DistributionTypes::Binomial,
            {{"numtrials", 10}, {"prob", 0.5}, {"weight", 0.75}}
    };
    std::vector<RandomDatasetGenerator::ColumnDataType> cols{binom};
